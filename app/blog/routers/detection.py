...
from ..DL_MODELS.bertvader import analyze_split_sentiments
...
@router.post("/aspect_based_sentiment_analysis", status_code=200)
async def aspect_based_sentiment_analysis(req: schemas.Sentimate):
    result = analyze_split_sentiments(req.user_input, req.aspect)
    return result
